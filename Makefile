...
OFILES = gba.o font.o logic.o graphics.o main.o images/basicBackground.o images/fBWDownLeft.o images/fBWDownRight.o images/fBWUpRight.o images/fBWUpLeft.o images/titleScreen.o images/testSprite.o
